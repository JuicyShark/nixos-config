...
with lib; let
  ...
  secrets = import "${inputs.nixflix}/lib/secrets" {inherit lib;};

  mkSecureCurl = import "${inputs.nixflix}/lib/mk-secure-curl.nix" {inherit lib pkgs;};
in {
